...
This document defines the **data** of Anchor and of a typical LLM in mathematical terms, then compares and contrasts them. It complements `UNIFIED_MATH_MODEL.md`, which covers the full pipelines.
